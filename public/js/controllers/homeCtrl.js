angular.module('perrosApp.controllers', []).
	controller('HomeCtrl', ['$scope', '$mdDialog', '$timeout', '$q', '$log', '$filter', '$mdToast', '$mdConstant', 'perrosService', 'PerroFactory','PerrosList','PerrosPaginator', function($scope, $mdDialog, $timeout, $q, $log, $filter, $mdToast, $mdConstant, perrosService, PerroFactory,PerrosList,PerrosPaginator) {
		$scope.LIMIT = 40;
	    ...
	    $scope.buscarPerroAvanzado = function(event, perro, tab){
	    	...
	    	switch(tab){
				case 0:
					$scope.searchModel.tipo = 'perdidos';
					break;
				case 1: 
					$scope.searchModel.tipo = 'encontrados';
					break;
				case 2:
					$scope.searchModel.tipo = 'avistados';
					break;
			}
